...
if matches[1] == 'حذف خوشامدگویی' and not matches[2] and is_owner(msg) then 
...
if matches[1] == 'تنظیم خوشامدگویی' and matches[2] and is_owner(msg) then
